    ...
    <section id="pricing" className="py-28 sm:py-36 bg-bg-light dark:bg-bg-dark border-b border-border-light dark:border-border-dark transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-stretch">
          ...
          {/* Pro Card */}
          <div className="bg-white dark:bg-card-dark border-2 border-primary dark:border-text-dark rounded-2xl p-8 flex flex-col justify-between shadow-sm relative">
            {/* Coming Soon Badge */}
